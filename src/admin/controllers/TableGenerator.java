...
public class TableGenerator {
    ...
    public static void mTable() {
        ...
        table.addCell(BOLD_BLUE + "ADMINISTRATION" + RESET, centerStyle);

        table.addCell(BRIGHT_GREEN + "REGISTER" + RESET, centerStyle);
        table.addCell(BRIGHT_GREEN + "LOGIN" + RESET, centerStyle);
